...
<body>
  ...
  <p>Please fill up this form to register for a Student account.</p>
  <!--eto ung nagcoconnect sa database-->
    ...
    <div id="error_msg"></div>
     <div>
      ...
      <div> 
      <input  type="submit" id="reg_btn"value="Sign up">
      <a type="button" class="btn btn-primary" href="login.php" style="margin-left: 55px; ">Already have an account?</a>
      </div>
    </form>
